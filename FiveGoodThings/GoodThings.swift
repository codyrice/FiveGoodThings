...
class GoodThings: NSObject, NSCoding {
    ...
    let dateTime: Date
    let goodThingsList: Array<String>
    ...
    struct PropertyKey {
        ...
        static let goodThingsList = "goodThingsList"
    }
    
    //MARK: Initialization
    
    init?(dateTime: Date, goodThingsList: Array<String>) {
        
        // Initialize stored properties.
        self.dateTime = dateTime
        self.goodThingsList = goodThingsList
    ...
    func encode(with aCoder: NSCoder) {
        ...
        aCoder.encode(goodThingsList, forKey: PropertyKey.goodThingsList)
    }
    ...
    required convenience init?(coder aDecoder: NSCoder) {
        ...
        // The goodThingsList is required. If we cannot decode a goodThingsList [String], the initializer should fail.
        guard let goodThingsList = aDecoder.decodeObject(forKey: PropertyKey.goodThingsList) as? [String] else {
            os_log("Unable to decode the list of good things for a good thing object.", log: OSLog.default, type: .debug)
            return nil
        }
        
        // Must call designated initializer.
        self.init(dateTime: dateTime, goodThingsList: goodThingsList)
    }
